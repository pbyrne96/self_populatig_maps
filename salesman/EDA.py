...
def plot_network(cities, neurons, name='diagram.png', ax=None):
    ...
    if not ax:
        ...
        axis.scatter(cities['latitude'], cities['longitude'], color='red', s=4)
        ...
        ax.scatter(cities['latitude'], cities['longitude'], color='red', s=4)
...
def plot_route(cities, route, name='diagram.png', ax=None):
    ...
    if not ax:
        ...
        axis.plot(route['latitude'], route['longitude'], color='purple', linewidth=1)
